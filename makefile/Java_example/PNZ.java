...
public class PNZ extends JApplet implements ActionListener {
    ...
    private void startNewGame() {
       ...
       responseField.setText("OK. Guess a number with 3 distinct digits.");
    }
    ...
    private void processGuess() {
       ...
       if(!validInput) {
          JOptionPane.showMessageDialog(null,
                                "Error: Your guess must be 3 distinct digits.");
          return;
       }
       ...
       if(guess.equals(target)) {
          responseField.setText("Right! You got it in " + count + " tries.");
          isGameOver = true;
       }
    }
